CREATE TABLE [dbo].Data_Parsed (	 
    ...
    [UmlBall100]        DECIMAL (4, 1)      NULL,
    [UmlBall12]         DECIMAL (4, 2)      NULL,
	[UmlBall]           DECIMAL (4, 1)      NULL,	
    ...
    [MathStBall12]      DECIMAL (4, 2)      NULL,
    [MathStBall]        DECIMAL (4, 1)      NULL,
    ...
    [EOName_Adjusted]   NVARCHAR (500)      NULL
);
